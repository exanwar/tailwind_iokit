      ...
      >
        <div>
          ...
          >
            ...
            <span class="ml-2 text-gray-600">Account</span>
          </a>
        </div>
        <div>
          <a
          ...
          >
            ...
            <span class="ml-2 text-gray-600">Analytics</span>
          </a>
        </div>
        <div>
          <a
          ...
          >
            ...
            <span class="ml-2 text-gray-600">Settings</span>
          </a>
        </div>
        <div>
          <a
          ...
          >
            ...
            <span class="ml-2 text-gray-600">Help</span>
          </a>
        </div>
      </div>
    </transition>
